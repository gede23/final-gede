...
import imgPlaceHolder from '../../assets/images/logo.png';
  ...
  return (
    <View style={styles.page}>
        ...
        {isEmailRegistered && (
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.iconCancel} onPress={onCancel}>
              <Image
                source={require('../../assets/icon/icons8-cancel-24.png')}
              />
            </TouchableOpacity>
          </View>
        )}
      ...
      <View style={styles.contentWrapper}>
        ...
        />
        <Gap height={24} />
        <Button label="Continue" onPress={() => navigation.navigate('MainApp')} />
      </View>
    </View>
  );
};
